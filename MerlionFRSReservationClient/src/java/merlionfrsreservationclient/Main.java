...
public class Main {
    ...
    public static void main(String[] args) {
        MainApp mainApp = new MainApp(fareSessionBean, seatsInventorySessionBean, flightRouteSessionBean, flightSessionBean, flightSchedulePlanSessionBean, flightScheduleSessionBean, airportSessionBean, customerSessionBean);
        mainApp.runApp();
    }
