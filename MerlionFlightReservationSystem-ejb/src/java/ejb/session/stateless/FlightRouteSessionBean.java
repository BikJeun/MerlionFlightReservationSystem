...
public class FlightRouteSessionBean implements FlightRouteSessionBeanRemote, FlightRouteSessionBeanLocal {
    ...
    public FlightRouteEntity searchForFlightRouteByOriginAndDestination(String originAirportIATA, String destinationAirportIATA) throws FlightRouteNotFoundException {
        Query query = em.createQuery("SELECT f FROM FlightRouteEntity f WHERE f.origin.IATACode = :codeOne AND f.destination.IATACode = :codeTwo");
    ...
    public List<FlightRouteEntity> retrieveAllFlightRouteInOrder() {
        Query query = em.createQuery("SELECT DISTINCT f FROM FlightRouteEntity f ORDER BY f.origin.airportName ASC"); //TODO : order complementary routes together
